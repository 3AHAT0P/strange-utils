type SimpleFNG<A extends any[] = any[], R = void> = (...arg: A) => Promise<R>;
...
> = Rest extends [infer InferFn, ...infer Rest1] ? (Rest1 extends readonly SimpleFN[] ? PipeHelperCheckInferFnArg<InferFn, P, A, Rest1, R> : never) : Rest;
...
type PipeHelperCheckInferFnArg<
  ...
  Rest extends readonly SimpleFN[] = P,
  R extends readonly SimpleFN[] = [],
> = TFn extends SimpleFNG<[A], infer InferReturn> ? CheckPipes<P, InferReturn, Rest, [...R, TFn]> : PipeHelperCheckInferFnArgFallback<TFn, P, A, Rest, R>;
...
type PipeHelperCheckInferFnArgFallback<
  ...
  Rest extends readonly SimpleFN[] = P,
  R extends readonly SimpleFN[] = [],
> = TFn extends SimpleFNG<[any], infer InferReturn> ? CheckPipes<P, any, Rest, [...R, SimpleFNG<[A], InferReturn>]> : never;
...
export const asyncPipe: AsyncPipe = (...fns: any[]): any => async (arg: any): Promise<any> => {
  let result = arg;
